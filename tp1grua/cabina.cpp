...
Cabina::Cabina() :
	...
	contra_peso(gris_oscuro), cable(negro), gancho(&material_gancho,negro,20),
...
void Cabina::actualizar_matrices_brazo() {
	...
	this->mo_brazo.set_model_matrix(ModelObject::line(glm::vec3(0.5, 0.0, 0.0), punto_final, 0.6f, 0.6f));
