...
glm::mat4 ModelObject::line(const glm::vec3& p0, const glm::vec3& p1, float anchox, float anchoy, float lfactor) {
	...
	m = glm::scale(m, glm::vec3(anchox, anchoy,distance*lfactor));

	return m;
}

glm::mat4 ModelObject::adjust_z(const glm::mat4& m, float z_factor) {
	return glm::scale(glm::mat4(1.0), glm::vec3(1.0, 1.0, 1.0/z_factor)) * m * glm::scale(glm::mat4(1.0), glm::vec3(1.0, 1.0, z_factor));
}
